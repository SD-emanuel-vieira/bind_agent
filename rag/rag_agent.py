...
# Delta table (embeddings + text) used for lexical fallback
EMB_TABLE = "bind_agent.docs.pdf_chunks_embeddings"

# Retrieval params
TOP_K_CANDIDATES = 40     # recall
TOP_K_FINAL = 8           # rerank top-k to build context
...
print("Fallback table:", EMB_TABLE)
