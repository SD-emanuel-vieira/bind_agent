...
BUSINESS_GLOSSARY_V2 = {
    ...
    "ROE": {"desc": "Return on Equity / Retorno sobre Patrimonio",
            "aliases": ["ROE","roe", "retorno sobre patrimonio", "return on equity", "rentabilidad sobre patrimonio", "retorno sobre el patrimonio"]},
